...
import { fetchUser, selectUser, setPrivacy, removePrivacy } from './actions';
    ...
    class User extends Component<Props, *> {
      ...
      renderPinnedTab() {
        ...
        if (stubUser) {
          return (
            <Link
              to={alias ? `/settings?claiming=${params.alias}` : `/join?claiming=${params.alias}`}
            >
            ...
            tabs={[
              {
                ...
                name: 'Overview',
                ignoreTitle: true,
                content: <Overview user={user} pvpSeasons={pvpSeasons} worlds={worlds} />,
              },
              {
                path: '/characters',
                name: 'Characters',
              ...
              },
              {
                ...
                content: (
                  ...
                  >
                    {(content, index) => (
                      <GuildContentCard key={makeKey(content, index)} content={content} />
                    )}
                  </PaginatorGrid>
                ),
              },
